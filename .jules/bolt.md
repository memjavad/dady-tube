...
## 2024-05-24 - Cache SharedPreferences getInstance
**Learning:** Calling `SharedPreferences.getInstance()` repeatedly has overhead.
**Action:** Cache the instance locally in the provider after the first lookup using a lazy getter.
