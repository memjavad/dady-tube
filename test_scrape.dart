  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      if (body.contains('ytInitialData = ')) {
        ...
        try {
          final videos = data['contents']['twoColumnBrowseResultsRenderer']['tabs'][1]['tabRenderer']['content']['richGridRenderer']['contents'];
          for (var i = 0; i < 3 && i < videos.length; i++) {
            final video = videos[i]['richItemRenderer']['content']['videoRenderer'];
