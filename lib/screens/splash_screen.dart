                    ...
                    children: [
                      ...
                      Consumer<ChannelProvider>(
                        builder: (context, provider, child) {
                          ...
                          if (provider.isInitialized && _controller.isCompleted) {
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  borderRadius: BorderRadius.circular(DadyTubeTheme.borderRadiusFull),
                                ),
                                child: Stack(
                                  children: [
                                    AnimatedContainer(
                                      ...
                                      decoration: BoxDecoration(
                                        gradient: LinearGradient(
                                          colors: [
                                            ...
                                            DadyTubeTheme.primary.withOpacity(0.8),
                                          ],
                                        ),
                                        borderRadius: BorderRadius.circular(DadyTubeTheme.borderRadiusFull),
                                        boxShadow: [
                                          BoxShadow(
                                            color: DadyTubeTheme.primary.withOpacity(0.4),
                                            blurRadius: 10,
                              ...
                              AnimatedDefaultTextStyle(
                                ...
                                style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                                  color: DadyTubeTheme.primary.withOpacity(0.7),
                                  fontWeight: FontWeight.w600,
                                ) ?? const TextStyle(),
                                child: Text(
                                  AppLocalizations.of(context).translate(
                                    provider.initStatusKey,
                                    args: provider.initStatusArg.isNotEmpty ? {'name': provider.initStatusArg} : null,
                                  ),
                                ),
                              ),
                            ],
