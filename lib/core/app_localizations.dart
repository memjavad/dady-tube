...
class AppLocalizations {
  ...
  static const _localizedValues = {
    'en': {
      ...
      'calm_mode_title': 'Bedtime Calm Mode',
      'calm_mode_desc': 'Interactive starry sky screen with falling stars',
      'soothing_noises': 'Play Soothing Night-Noises',
      'default_noise_title': 'Default Bedtime Noise',
      'lullaby': 'Music Box',
      'rain': 'Gentle Rain',
      'ocean': 'Ocean Waves',
      'white_noise': 'Cozy Breeze',
      ...
      'smart_night_sync_title': 'Smart Night Sync',
      'smart_night_sync_desc': 'Silent overnight caching of the latest videos per channel on WiFi.',
      'sync_time_title': 'Sync Time',
      'videos_limit_title': 'Videos per Channel',
      'am': 'AM',
      'pm': 'PM',
    ...
    'ar': {
      ...
      'calm_mode_title': 'الوضع الهادئ للنوم',
      'calm_mode_desc': 'شاشة سماء مرصعة بالنجوم تفاعلية مع شهب ساقطة',
      'soothing_noises': 'تشغيل أصوات الليل المهدئة',
      'default_noise_title': 'صوت النوم الافتراضي',
      'lullaby': 'صندوق الموسيقى',
      'rain': 'مطر خفيف',
      'ocean': 'أمواج المحيط',
      'white_noise': 'نسيم مريح',
      ...
      'smart_night_sync_title': 'المزامنة الليلية الذكية',
      'smart_night_sync_desc': 'تحميل صامت لأحدث الفيديوهات لكل قناة ليلاً عند الاتصال بالواي فاي.',
      'sync_time_title': 'وقت المزامنة',
      'videos_limit_title': 'عدد الفيديوهات لكل قناة',
      'am': 'صباحاً',
      'pm': 'مساءً',
