...
class AppLocalizations {
  ...
  static const _localizedValues = {
    'en': {
      ...
      'english': 'English',
      'arabic': 'Arabic (Iraq)',
      'eye_protection': 'Eye Protection (Blue Light Filter)',
      ...
      'safety_pause': 'Safety Pause: Step back to resume fun!',
    ...
    'ar': {
      ...
      'eye_protection': 'حماية العين (فلتر الضوء الأزرق)',
      ...
      'safety_pause': 'توقف للأمان: ابتعد قليلاً للمتابعة!',
